				...
				<div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
					<div class="row menu-dark">
						<div class="col-lg-6">
							...
							<!-- menu item -->
							<div class="menu-item">
								<h5>Battered Pickles</h5>
								<div class="mi-meta">
									
									<div class="menu-price">$4.49</div>
								</div>
							</div>
														<!-- menu item -->
							<div class="menu-item">
						...
						<div class="col-lg-6">
							<!-- menu item -->
							<div class="menu-item">
								<h5>SShrimps  (7 pcs)</h5>
								<div class="mi-meta">
									
									<div class="menu-price">$9.79</div>
								</div>
							</div>
							<!-- menu item -->
							<div class="menu-item">
								<h5>Jumbo Shrimps (12 pcs)</h5>
								<div class="mi-meta">
